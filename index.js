...
do {
    ...
    if (opponent.select == "Robot") {
        console.log(`${chalk.bold.blue(player1.name)} VS ${chalk.bold.red(opponent1.name)}`);
        ...
        if (ask.opt == "Drink Portion") {
            ...
            console.log(chalk.bold.greenBright(`You Drink Health Portion Your Fuel is ${player1.fuel}`));
        }
